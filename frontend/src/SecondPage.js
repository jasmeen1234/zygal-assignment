...
const SecondPage = () => {
  ...
  return (
    <div className="container bg-gray-300 w-3/4 h-full p-4 flex items-center justify-center">
      <div className="form-card p-6 bg-gray-200 rounded-lg shadow-md w-full max-w-md">
